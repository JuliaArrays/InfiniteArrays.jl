...
print_matrix_row(io::IO, X::AbstractVecOrMat, A::Vector, i::Integer, cols::AbstractVector, sep::AbstractString, idxlast::RealInfinity) = print_matrix_row(io, X, A, i, cols, sep, ℵ₀)
